...
export default function Index() {
  ...
  const checkCompatibility = (sign1: string, sign2: string): string => {
    ...
    if (compatibilityLevel === 'High') {
      return t("compatibility.compatible");
    } else if (compatibilityLevel === 'Medium') {
      return t("compatibility.moderately_compatible");
    } else {
      return t("compatibility.incompatible");
    }
  };
  ...
  return (
    ...
    >
      ...
      <SafeAreaView className="abolsute z-10 flex-1 w-full px-5">
        ...
        <Text className="text-white text-2xl font-abold text-center my-5">{t("compatibility.title")}</Text>
          ...
          <View className='flex-row items-center w-[260px] justify-between mb-11 h-14'>
            ...
            <View className='flex-col items-center '>
              <Text className="text-white text-2xl font-abold">
                {t(`zodiac_signs.${zodiacSigns[selectedSign1].value}.title`)}
              </Text>
              <Text className="text-[#C8C8C8] font-aregular ">{t(`zodiac_signs.${zodiacSigns[selectedSign1].value}.date`)}</Text>
        ...
        <View className='flex-col items-center justify-center'>
          ...
          <View className='flex-row items-center w-[260px] justify-between mt-11 h-14'>
            ...
            <View className='flex-col items-center '>
              <Text className="text-white text-2xl font-abold ">
              {t(`zodiac_signs.${zodiacSigns[selectedSign2].value}.title`)}
              </Text>
              <Text className="text-[#C8C8C8] font-aregular ">{t(`zodiac_signs.${zodiacSigns[selectedSign2].value}.date`)}</Text>
        ...
        <TouchableOpacity onPress={handleCheckCompatibility} className={`bg-[#DAA520] p-4 rounded-2xl w-full mt-4`}>
          <Text className="text-[#8C2F00] text-xl font-aregular text-center  ">{t("compatibility.check_compatibility")}</Text>
        </TouchableOpacity>
      </SafeAreaView >
